...
$(document).ready(function () {
    ...
    $("#add").click(function () {
        ...
        if ($("#batchId").val() === "") {
            ...
            $.ajax({
                url: `/Admin/Batch-${$("#batchId").val()}/Product`,
                type: "GET",
                    ...
                    if (res.Message === true) {
                        ...
                        if (item !== undefined) {
                            ...
                            if (productQuantity == 0) {
                                alert("This item does not exist! Please try again!");
                            }
                            else
                                if (inputQuantity > productQuantity && productQuantity != 0) {
        ...
        if (items.length == 0) {
            ...
            if ($("#cash").val() == "") {
                ...
                if (parseInt($("#cash").val()) < total) {
                    ...
                    $.ajax({
                        url: "/Admin/Purchasing/AddPurchase",
                        type: "POST",
                        data: data,
                        datatype: "json",
                        success: function (res) {
